...
//  Created by Sarath R on 01/11/16.
...
public final class CDHelper {
    ...
    fileprivate static var _sharedInstanceCDStore = CoreDataStore()
    ...
    public class func initializeWithContext() {
        self._sharedInstance._mainContext = _sharedInstanceCDStore.managedObjectContext
        ...
        ValueTransformer.setValueTransformer(LoginUserDataToDataValueTransformer(), forName: NSValueTransformerName(rawValue: "LoginUserDataToDataValueTransformer"))
    }
...
public extension CDHelperEntity {
    ...
    func contextDidSaveContext(notification: NSNotification) {
        ...
        sender.perform {
            sender.mergeChanges(fromContextDidSave: notification as Notification)
        }
    }
